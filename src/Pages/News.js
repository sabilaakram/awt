...
<div className="container">
        <div className="row">
            ...
            <div className="col-lg-4">
                <div className="newsinfo">
                    <h3>  Agreement Signing Ceremony - Army Welfare Trust & Pakistan Hockey Federation </h3>
                    <p>   AWT Determined for Revival of the Glorious Past - Pakistan Hockey</p>
        ...
        <div className="row">
            ...
            <div className="newsinfo">
                    ...
                    <p>   AGL SAP Business Go-Live ceremony held at AWT plaza, Rawalpindi on 22 Mar 2023. Rollout of HCM apps are in progress.</p>
            ...
            <div className="newsinfo">
                    ...
                    <p>   Inaugurated by Lt Gen Naveed Mukhtar, HI(M) Retd MD AWT on 19 July 2023</p>
        ...
        <div className="row">
            ...
            <div className="col-lg-4">
                <div className="newsinfo">
                    ...
                    <p>   Digital Transformation & Cyber Security Seminar - 09 March 2023</p>
            ...
            <div className="col-lg-4">
                <div className="newsimages">
                <img src={new5} className="img-fluid" />
                </div>
            </div>
        </div>
      </div>
