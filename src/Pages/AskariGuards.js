          ...
          <div className="row d-flex justify-content-start align-items-center">
            <div className="col-lg-6">
              <div className="ourmission">
                ...
                <p>
                  Askari Guards (Pvt) Limited (AGL), a subsidiary of the Army
                  Welfare Trust, embarked on its mission in 1996. Since its
                  inception, AGL has maintained a robust presence throughout
                  Pakistan delivering an unparalleled standard of security,
                  armed with excellent equipment. Askari Guards provides
                  guarding services to well-recognized national and
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="aboutus">
                ...
                <h2>Your Trusted Provider for Finest Guarding Solutions</h2>
                <p>
                  We are dedicated to your safety and you can rely on us for
                  top-notch security collaboration. Our ongoing efforts
                  positively influence numerous lives, and we are committed to
                  achieving significant advancements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row  d-flex justify-content-start align-items-center">
            ...
            <div class="col-lg-6">
              <div class="ourmission">
                ...
                <h2>How Askari Guards Support AWT</h2>
                <p>
                  As a subsidiary of Army Welfare Trust, Askari Guards
                  contributes to its noble goal by rendering employement
                  opportunities to veterans. This ensures that they are playing
                  their part in the well-being of retired army personnel and
                  recruiting the best guarding manpower. Also, the capital made
                  is utilized in the activities of Army’s welfare.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row spacebottom">
            <div className="col-lg-12">
              <div className="aboutus">
                ...
                <h2>All-Inclusive Security Services for Your Protection</h2>
                <p>
                  Askari Guards presents comprehensive services to guard the
                  lives and properties of our clients. We assure that your
                  safety is our top commitment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row  ">
            <div className="col-lg-4">
              <div class="card">
                ...
                <p>
                  As a pioneer in Pakistan's security services industry, AGL
                  provides world-class, customized security solutions.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4">
              <div class="card">
                ...
                <p>
                  AGL is a top cash transportation operator in Pakistan, known
                  for secure, efficient, and reliable CIT services.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4">
              <div class="card">
                ...
                <p>
                  AGL takes pride to be one of the leading providers of
                  comprehensive technical security solutions.
                </p>
              </div>
            </div>
          </div>
