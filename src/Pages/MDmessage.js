      ...
      <section className="aboutusbox">
        <div className="container">
            <div className="row d-flex justify-content-start align-items-center">
                ...
                <span className="leftlineheading"> MANAGING DIRECTOR's COMMUNIQUE </span>
                <h2>Lt Gen Naveed Mukhtar 
HI (M) (Retd)</h2>
                <p>
                ...
                <div className="col-lg-4">
                    ...
                    <img src={mdmessage}  className="img-fluid"/>
                    </div>
      ...
      <section >
            ...
            <div className="row">
                ...
                <p> Let us devote all our mental and physical energies in the pursuit of excellence. I am confident that with the blessings of Allah and with our will and hard work, together we shall realize our vision, lnshAIIah.

</p>

<p>May Allah be our Helper, Protector and Guide, Ameen.
